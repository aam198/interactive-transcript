...
jwplayer("container").setup({
    file: 'https://content.jwplatform.com/manifests/3p683El7.m3u8',
    image: 'https://content.jwplatform.com/thumbs/3p683El7-640.jpg',
    tracks: [
      { file: "chapters.vtt", kind: "chapters" },
      { file: "captions.vtt", kind: "captions" },
...
jwplayer().addButton(
  ...
  "Download Slides",
  function() {
    window.location.href = "state-html5-video.pdf";
  },
  "download"
);
